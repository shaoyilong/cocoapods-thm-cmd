...
# require 'cocoapods-thm-cmd/native/installation_options'
require 'cocoapods-thm-cmd/gem_version'
# require 'cocoapods-thm-cmd/command/bin/archive'
      ...
      define_method(:resolver_specs_by_target) do
        ...
        specs_by_target.each do |target, rspecs|
          ...
          specs_by_target[target] = rspecs.map do |rspec|
            ...
            UI.message 'cocoapods-thm-cmd 插件'
